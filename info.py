...
BOT_TOKEN = environ.get('BOT_TOKEN', '8369255046:AAFcGXH6uh0AHeEYfRwKD-WPDQfbEi6MB2U')
#---------------------------------------------------------------
#---------------------------------------------------------------
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '7123837674').split()]
USERNAME = environ.get('USERNAME', "https://t.me/BruceJaat") # ADMIN USERNAME
...
#---------------------------------------------------------------
#---------------------------------------------------------------
START_IMG = (environ.get('START_IMG', 'https://i.ibb.co/Kz0QJXZH/Img2url-bot.jpg https://i.ibb.co/Kz0QJXZH/Img2url-bot.jpg')).split()
FORCESUB_IMG = environ.get('FORCESUB_IMG', 'https://i.ibb.co/Kz0QJXZH/Img2url-bot.jpg')
